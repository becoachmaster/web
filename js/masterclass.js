...
function calcularProximoWebinar(ahora, horaWebinar) {
  ...
  const JUEVES = 4; // 0=Dom, 1=Lun, ..., 4=Jue
  const diasParaJueves = (JUEVES - ahora.getDay() + 7) % 7;
  proxima.setDate(proxima.getDate() + diasParaJueves);

  // Proxima clase: jueves a la hora configurada.
  if (proxima <= ahora) {
